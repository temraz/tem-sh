					...
					<div class="container">
						...
						<div class="row">
							...
							<img  src="<?php echo base_url();?>images/logo.png">
														...
														<h3 style="margin-top:55px ;float:left  ; margin-left:15px ; color:#fff">Sheir</h3>
					...
					<div class="row">
						<div class="span3">
                            ...
                            <ul class="nav nav-list primary pull-bottom">
									...
									<li class="active"><a href="<?php echo base_url(); ?>admin/users">Actived Users <strong>(<?php $this->load->model('civou/admin_model'); echo count($this->admin_model->get_confirmed_user()); ?>)</strong></a></li>
