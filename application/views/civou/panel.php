					...
					<div class="row">
						<div class="span3">
                            ...
                            <ul class="nav nav-list primary pull-bottom">
									<li class="active"><a href="<?php echo base_url(); ?>admin/panel">Unconfirmed Users <strong>(<?php $this->load->model('civou/admin_model'); echo count($this->admin_model->get_unconfirmed_user()); ?>)</a></strong></li>
