					...
					<div class="row">
						...
						<ul class="portfolio-list sort-destination" data-sort-id="portfolio">
							<li class="span3 isotope-item websites">
								<div class="portfolio-item thumbnail">
									<a href="portfolio-single-project.html"  class="thumb-info">
										<img alt="" src="<?php echo base_url();?>images/project-3.jpg" >
							...
							<li class="span3 isotope-item brands">
								<div class="portfolio-item thumbnail">
									<a href="portfolio-single-project.html" tppabs="http://www.crivos.com/themes/porto/portfolio-single-project.html" class="thumb-info">
										<img alt="" src="<?php echo base_url();?>images/project-3.jpg" tppabs="http://www.crivos.com/themes/porto/img/projects/project-1.jpg">
										<span class="thumb-info-title">
							...
							<li class="span3 isotope-item logos">
								<div class="portfolio-item thumbnail">
									<a href="portfolio-single-project-3.html" tppabs="http://www.crivos.com/themes/porto/portfolio-single-project.html" class="thumb-info">
										<img alt="" src="<?php echo base_url();?>images/project-2.jpg" tppabs="http://www.crivos.com/themes/porto/img/projects/project-2.jpg">
										<span class="thumb-info-title">
							...
							<li class="span3 isotope-item websites">
								<div class="portfolio-item thumbnail">
									<a href="portfolio-single-project.html" tppabs="http://www.crivos.com/themes/porto/portfolio-single-project.html" class="thumb-info">
										<img alt="" src="<?php echo base_url();?>images/project-3.jpg" tppabs="http://www.crivos.com/themes/porto/img/projects/project-3.jpg">
										<span class="thumb-info-title">
							...
							<li class="span3 isotope-item brands">
								<div class="portfolio-item thumbnail">
									<a href="portfolio-single-project.html" tppabs="http://www.crivos.com/themes/porto/portfolio-single-project.html" class="thumb-info">
										<img alt="" src="<?php echo base_url();?>images/project-1.jpg" tppabs="http://www.crivos.com/themes/porto/img/projects/project-1.jpg">
										<span class="thumb-info-title">
											<span class="thumb-info-inner">Red Wine</span>
											<span class="thumb-info-type">Brand</span>
										</span>
